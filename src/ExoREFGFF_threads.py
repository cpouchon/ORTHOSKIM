...
def GeneExtraction(genenumber):
    ...
    if len(besthits[geneid])==1:
        ...
        seqid = besthits[geneid][0][1].replace(";","")
    ...
    header = ">"+str(geneid)+"_"+str(nameofsample)
    cond_min_length=0
...
'read seeds genes to keep the ref to initiate the gff line/gene'
