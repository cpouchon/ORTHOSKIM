...
parser.add_argument('--seqs', help='sequence names of rfam', type=str)
...
#seqnam --> prendre les headers des sequences fasta rfam
...
with open(seqnam) as t:
    for l in t:
        toprint=list()
        line=l.rstrip()
        access=line
        ncbi_access=line.split("/")[0].split(".")[0]
